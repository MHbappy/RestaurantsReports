...
public class DashBoard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://admin.royalrestaurantbd.com/api-dashboard?username="+name+"&password="+pass;
...
//                Intent intent2 = new Intent(DashBoard.this, ReportActivity.class);
//                startActivity(intent2);
            ...
            case R.id.summary_report:
                Intent intent1= new Intent(DashBoard.this, SummaryActivity.class);
